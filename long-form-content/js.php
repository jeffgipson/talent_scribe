...
// show the loading screen
                    ...
                    var title = jQuery('#title').val();
                    var company_summary = "<?php echo get_option('rw-ts_company_summary'); ?>"
                    var company_profile = "<?php echo get_option('rw-ts_company_profile'); ?>"
                    //if company profile is not empty add it to the prompt
                    if (company_profile != '') {
                    ...
                    jQuery.ajax({
                        ...
                        success: function (response) {
                            ...
                            var company_profile = "<?php echo get_option('rw-ts_company_profile'); ?>".replaceAll("'","\'")
                            //if company profile is not empty add it to the prompt
                            if (company_profile != '') {
