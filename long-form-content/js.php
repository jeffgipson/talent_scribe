                                ...
                                success: function (response) {
                                    ...
                                    jQuery.ajax({
                                        ...
                                        success: function (response) {
                                            ...
                                            var prompt = "Please evaluate this blog post titled:" + title + " . The post has 3 main section: the Introduction:" + intro + " , the body:" + body + " and the conclusion:" + conclusion + ". Rewrite, reformat and return with rich text and html with bold headings. Please remove any repetition. The final blog post should be 800 - 1200 words. Remove any unnecessary words, phrases, sentence and paragraphs in order to keep on topic, clear and concise and stop repeating the same content. The conclusion should be a single paragraph and should not repeat the same words or phrases as the introduction or body. Only have one conclusion paragraph please condense the conclusion.  .";
                                            jQuery.ajax({
                                                url: url,
                                                type: 'POST',
                                                dataType: 'json',
