...
// show the loading screen
                    ...
                    jQuery.ajax({
                        ...
                        success: function (response) {
                            ...
                            var prompt = "Blog Title: " + title + " Introduction: " + intro + " Build the main body with 400 - 600 words across 3-5 sections. Each section starts with a HTML bold heading. Remember: Avoid redundancy or content repetition from the introduction. Maintain brevity with paragraph use. A conclusion will be crafted in a later prompt."
                            var url = "https://api.openai.com/v1/completions"
                            jQuery.ajax({
                                url: url,
                                type: 'POST',
                                ...
                                success: function (response) {
                                    ...
                                    jQuery.ajax({
                                        ...
                                        success: function (response) {
                                            ...
                                            var prompt = "Given the informative blog titled: '" + title + "' and its content: " + intro + " " + body + " " + conclusion + ", revamp this into a compelling post from an executive recruiter's perspective. Employ rich text and HTML formatting with enticing headings. Limit to 800 to 1200 words, subtly highlighting our company in 1% of the content. Ensure clarity and brevity without repetition or excessive paragraph use. Avoid including the blog title at the start."
