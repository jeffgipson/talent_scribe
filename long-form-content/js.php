                                ...
                                success: function (response) {
                                    ...
                                    jQuery.ajax({
                                        ...
                                        success: function (response) {
                                            ...
                                            var prompt = "We are writing a blog post titled:" + title + " . Based on our brainstorming this is what we have so far: " + intro + " " + body + " " + conclusion + ". Pretend you an executive recruiter and turn this into a blog post with rich text and html with bold headings. Please use synonyms and rewrite phrases and sentence to remove any repetition and insure a great reader experience by staying on topic and not repeating content. The post should be 95% educational and informative and 5% about us maybe toward the end. DO NOT print the post title at the top. The final blog post MUST BE 800 - 1200 words ";
                                            jQuery.ajax({
                                                url: url,
                                                type: 'POST',
                                                dataType: 'json',
