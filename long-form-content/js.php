...
// show the loading screen
                    ...
                    var prompt = "Background: " + company_summary + " Blog Title: " + title + " Construct an introduction of 175 - 250 words focusing on reader value. Note: Maintain clarity without overuse of paragraphs. Refrain from repeating content or using 'in this blog', 'in this blog post', or 'in this article'. The blog's body will be addressed separately."
                    var url = "https://api.openai.com/v1/completions"
                    jQuery.ajax({
                        url: url,
                        type: 'POST',
                        ...
                        success: function (response) {
                            ...
                            var prompt = "Blog Title: " + title + " Introduction: " + intro + " Build the main body with 400 - 500 words across 3-5 sections. Each section starts with a HTML bold heading. Remember: Avoid redundancy or content repetition from the introduction. Maintain brevity with paragraph use. A conclusion will be crafted in a later prompt."
                            var url = "https://api.openai.com/v1/completions"
                            jQuery.ajax({
                                url: url,
                                type: 'POST',
                                ...
                                success: function (response) {
                                    ...
                                    var prompt = "Company Reference: " + company_summary + " Blog Title: " + title + " Content so far: " + intro + ' ' + body + " Conclude with unique content, subtly incorporating our company's focus. Ensure: No content repetition or overuse of paragraphs. Avoid 'in conclusion', 'in summary', 'in this blog', or 'in this article'."
                                    var url = "https://api.openai.com/v1/completions"
                                    jQuery.ajax({
                                        url: url,
                                        type: 'POST',
                                        ...
                                        success: function (response) {
                                            ...
                                            var prompt = "Given the informative blog titled: '" + title + "' and its content: " + intro + " " + body + " " + conclusion + ", revamp this into a compelling post from an executive recruiter's perspective. Employ rich text and HTML formatting with enticing headings. Limit to 800 to 1100 words, subtly highlighting our company in 1% of the content. Ensure clarity and brevity without repetition or excessive paragraph use. Avoid including the blog title at the start."
